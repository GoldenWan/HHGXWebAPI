(function () {
    ...
    //获取用户类型列表
    function getUserType(node, user, value) {
        var op = "";
        var info = {UserBelongTo: user}
        HH.post("/Users/GetUserType", info, function (data) {
            if (data.DataBag) {
                var myJson = data.DataBag;
                $.each(myJson, function (i, v) {
                    op = op + "<option value='" + v.UserTypeID + "'>" + v.UserTypeName + "</option>";
                });
                $(node).html(op);
                if (value) {
                    $(node).val(value);
    ...
    getUserType("#userType_add", user_type);
    ...
    $("#in_page").on("click", ".btn_edit", function () {
        ...
        HH.post("/Users/GetUser", {Userid: operationId}, function (data) {
            if (data.DataBag) {
                ...
                getUserType("#userType_edit", user_type, myJson.UserTypeID);
