...
public class ManagerOrg {
	...
	private String manageOrgGrade;   // 是否设置接警平台
	private String pName;            // 联系电话
	private String managerJob;       // 状态
	private String contactName;      // 区域名称
	private String contactTel;       // 地址
	private String address;          // 级别
	private String ynSetMonitor;     // 负责人
	private String status;           // 负责人职务
	private String parentID;         // 联系人姓名
